return function(self)
  --background--
	...
	if self.players.player1.locked == 1 and self.light_up == 1 then
	...
	if self.players.player2.locked == 1 and self.light_up == 2 then
		love.graphics.setColor(1,1,1)
	end
	...
	if self.players.player3.locked == 1 and self.light_up == 3 then
		love.graphics.setColor(1,1,1)
	end
	...
	if self.players.player4.locked == 1 and self.light_up == 4 then
		love.graphics.setColor(1,1,1)
	end
