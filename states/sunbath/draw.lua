return function(self)
	...
	love.graphics.printf(string.format("%d", self.players.player1.player_score or 0),0,50,love.graphics.getWidth()*0.25,"center")
	love.graphics.printf(string.format("%d", self.players.player2.player_score or 0),love.graphics.getWidth()*0.25,50,love.graphics.getWidth()*0.25,"center")
	love.graphics.printf(string.format("%d", self.players.player3.player_score or 0),love.graphics.getWidth()*0.5,50,love.graphics.getWidth()*0.25,"center")
	love.graphics.printf(string.format("%d", self.players.player4.player_score or 0),love.graphics.getWidth()*0.75,50,love.graphics.getWidth()*0.25,"center")
	--alfa
	love.graphics.printf(string.format("%.1f", self.players.player1.alfa or 0),0,lg.getHeight()-50,love.graphics.getWidth()*0.25,"center")
	love.graphics.printf(string.format("%.1f", self.players.player2.alfa or 0),love.graphics.getWidth()*0.25,lg.getHeight()-50,love.graphics.getWidth()*0.25,"center")
	love.graphics.printf(string.format("%.1f", self.players.player3.alfa or 0),love.graphics.getWidth()*0.5,lg.getHeight()-50,love.graphics.getWidth()*0.25,"center")
	love.graphics.printf(string.format("%.1f", self.players.player4.alfa or 0),love.graphics.getWidth()*0.75,lg.getHeight()-50,love.graphics.getWidth()*0.25,"center")
	--towel--
